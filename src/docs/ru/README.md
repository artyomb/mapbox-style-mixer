...
- **Интерактивный предварительный просмотр**: Веб-интерфейс карты на базе gem maplibre-preview с расширенной фильтрацией, мониторингом производительности и навигацией по исходным стилям
...
- **[Gem MapLibre Preview](https://github.com/artyomb/maplibre-preview)** - Расширенный интерфейс предварительного просмотра карт с фильтрацией и управлением слоями
...
| `/map` | GET | Интерактивный интерфейс предварительного просмотра карты (на базе gem maplibre-preview) | HTML |
...
- Bundler
- Docker (опционально)
- gem maplibre-preview (устанавливается автоматически)
